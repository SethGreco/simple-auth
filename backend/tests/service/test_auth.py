...
# import pytest
# from backend.qftb.service.auth_service import (
...
# from qftb.schemas import UserInfo
...
#     user_info = UserInfo(username="test_user", id=123)
...
#         # Generate token
#         token = generate_access_token(user_info, expires_delta)
